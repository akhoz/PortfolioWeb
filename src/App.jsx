        ...
        <div className="flex flex-col min-h-screen">
            ...
            <div className="flex flex-grow flex-col items-center mt-36">
                ...
                <div className='flex flex-grow flex-col justify-center text-center space-y-5 mb-5 px-3 md:space-y-0 md:space-x-5 md:mb-24 md:flex-row md:w-fit'>
                    <CustomCard  imgSrc='/wallhaven-3lyrvy_1920x1080.png' title='About Me' description='Here you can find general information about me.' />
                    <CustomCard  imgSrc='/wallhaven-3lyrvy_1920x1080.png' title='Projects' description='Explore the projects I&apos;ve developed in this section.' />
                    <CustomCard  imgSrc='/wallhaven-3lyrvy_1920x1080.png' title='Skills' description='Discover my skills in tech and math.' />
                </div>
